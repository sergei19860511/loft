...
<div style="float: left; border-bottom: 2px solid #63000c; width: 690px; margin: 0 5px;"></div> 
<div class="commenttext"><?php comment_text() ?></div> <div class="postbot"></div>  
...
<h3 class="comments"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?>:</h3>
