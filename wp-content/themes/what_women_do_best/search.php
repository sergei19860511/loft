...
<div class="post">
<div class="posttop"></div>
<div class="ptitle"><h2 class="title">No posts found. Try a different search?</h2></div>
<div class="entry">

		<p><center><?php include(TEMPLATEPATH."/src_form.php");?> </center> <h3 class="center">or take a look at the Archives.</h3> <?php include(TEMPLATEPATH."/archives.php");?> </p></div>
<div class="postbot"></div></div>
